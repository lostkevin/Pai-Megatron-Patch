#!/bin/bash
# sh run_evaluate_megatron_llama.sh dsw /workspace/Megatron-LM-23.04 /workspace/PAI-Megatron-Patch/ 70B 1 2048 80 0 fp16 2 1 /mnt/llama-datasets/wudao_train.jsonl /mnt/llama2-ckpts/Llama-2-70b-hf-to-megatron-tp2-pp1
