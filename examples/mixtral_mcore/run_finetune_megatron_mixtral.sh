#!/bin/bash
#sh run_finetune_megatron_mixtral.sh dsw ../.. 0.125B 1 1e-5 1e-6 80 80 0 bf16 2 1 sel false false true false  /mnt/llama2-datasets/alpaca_data.json /mnt/llama2-datasets/alpaca_data.json /mnt/mistral-ckpts/Mistral-7B-v0.1 2 /mnt/output_patch_test
set -e
ENV=$1
