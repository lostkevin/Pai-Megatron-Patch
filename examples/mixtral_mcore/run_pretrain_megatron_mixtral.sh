#!/bin/bash
#sh run_pretrain_megatron_mixtral.sh dsw ../.. 7B 1 8 1e-5 1e-6 80 80 0 bf16 1 1 sel false false false false 100  /mnt/llama2-datasets/alpaca_data.json /mnt/mixtral-ckpts/Mixtral-8x7B-v0.1 10000000000 100000000 /mnt/test_mixtral_output
#sh run_pretrain_megatron_mixtral.sh dsw ../.. 7B 1 8 1e-5 1e-6 80 80 0 bf16 2 1 sel false false true false 100  /mnt/llama2-datasets/alpaca_data.json /mnt/mixtral-ckpts/Mixtral-8x7B-v0.1 10000000000 100000000 /mnt/test_mixtral_output
