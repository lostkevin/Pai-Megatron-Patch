#!/bin/bash
#sh run_finetune_megatron_llava.sh dsw /workspace/Pai-Megatron-Patch 7B 4 1e-5 1e-6 120 120 0 bf16 1 1 sel true false true false  /mnt/llama2-datasets/alpaca_data.json /mnt/llama2-datasets/alpaca_data.json /mnt/llama2-ckpts/Llama-2-7b-hf-to-mg-tp1-pp1/ 2 /mnt/output_patch_test
set -e
ENV=$1
