#!/bin/bash
#sh run_finetune_megatron_yi.sh dsw /workspace/Pai-Megatron-Patch 7B 2 1e-5 1e-6 80 80 0 bf16 1 1 sel true false true false  /mnt/llama2-datasets/alpaca_data.json /mnt/llama2-datasets/alpaca_data.json /mnt/yi-ckpts/Yi-6B-to-mg-tp1-pp1 2 /mnt/output_patch_test
set -e
ENV=$1
...
run_cmd="torchrun $DISTRIBUTED_ARGS finetune_megatron_yi.py
